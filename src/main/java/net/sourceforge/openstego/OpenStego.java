...
public class OpenStego
{
    ...
    static
    {
        LabelUtil.addNamespace(NAMESPACE, "net.sourceforge.net.sourceforge.openstego.resource.OpenStegoLabels");
    }
    ...
    /**
     * Main method for calling net.sourceforge.openstego from command line.
     *
